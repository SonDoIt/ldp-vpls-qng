...
export default function NotFound() {
  return (
    <section className="relative overflow-hidden pt-40 pb-[var(--section-space)] md:pt-48">
      <p
        aria-hidden="true"
        className="pointer-events-none absolute top-24 left-1/2 -translate-x-1/2 bg-[linear-gradient(180deg,var(--color-sand),transparent_85%)] bg-clip-text font-display text-watermark text-transparent select-none"
      >
        404
      </p>
